...
def get_stylesheet():
    ...
    accent_color = '#d0d0e5'  # A shade of gray
    text_color = '#333333'
    border_radius = '0px'
    border_width = '1px'
    ...
    stylesheet = (
        ...
        f"QPushButton:hover {{ background-color: darken({accent_color}, 15%); }}"
        ...
        f"QTabBar::tab:selected {{ background-color: {accent_color}; color: {text_color}; border-top: {border_width} solid {accent_color}; }}"
